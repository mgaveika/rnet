        ...
        <GuestRoute>
            <SafeAreaView className='flex-1 items-center bg-primary'>
                ...
                <View className='w-full flex-col items-center gap-4 mt-32'>
                    <Pressable onPress={() => router.replace('/auth/register')} className='w-32 bg-special px-5 py-5 rounded-full'>
                        <Text className='text-button text-center'>Register</Text>
                    </Pressable>
                    <Pressable onPress={() => router.replace('/auth/login')} className='w-32 bg-special px-5 py-5 rounded-full'>
